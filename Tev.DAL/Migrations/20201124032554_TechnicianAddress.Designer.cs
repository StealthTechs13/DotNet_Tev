...
namespace Tev.DAL.Migrations
{
    ...
    [Migration("20201124032554_TechnicianAddress")]
    partial class TechnicianAddress
    {
            ...
            modelBuilder.Entity("Tev.DAL.Entities.InvoiceSubscriptionAssociation", b =>
                {
                    ...
                    b.Property<int?>("PayementInvoiceAssociationId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PayementInvoiceAssociationId");
            ...
            modelBuilder.Entity("Tev.DAL.Entities.InvoiceSubscriptionAssociation", b =>
                {
                    b.HasOne("Tev.DAL.Entities.PayementInvoiceAssociation", "PayementInvoiceAssociation")
                        ...
                        .HasForeignKey("PayementInvoiceAssociationId");
                });
