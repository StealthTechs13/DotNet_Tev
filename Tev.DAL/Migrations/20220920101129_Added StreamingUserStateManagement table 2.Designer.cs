...
namespace Tev.DAL.Migrations
{
    ...
    [Migration("20220920101129_Added StreamingUserStateManagement table 2")]
    partial class AddedStreamingUserStateManagementtable2
    {
            ...
            modelBuilder.Entity("Tev.DAL.Entities.StreamingUserStateManagement", b =>
                {
                    ...
                    b.Property<bool>("IsUSserActive")
                        .HasColumnType("bit");

                    b.Property<DateTime>("LastUodatedDate")
                        .HasColumnType("datetime2");
